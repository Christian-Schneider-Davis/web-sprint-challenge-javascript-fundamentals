...
//nestedFunction can access the variable internal because of function scope. Function scope allows internal to be accessed by nestedFunction privately since nestedFunction was created inside myFunction.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(){
    const lowerCase = zooAnimals.map(animal_name.toLowerCase());
  ...
  */
  ...
  function lowPopulationAnimals(newNew){
    let newArray = zooAnimals.filter();
  ...
  */
  ...
  function USApop(newReduce){
    const newSet = zooAnimals.reduce((total, state) => {
...
*/
function CuboidMaker(getVolume){
 constructor (attrs);
